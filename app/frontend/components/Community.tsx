...
import { Button, Card, CardContent, CardHeader, CardTitle, Badge, Avatar, AvatarFallback, AvatarImage, Tabs, TabsContent, TabsList, TabsTrigger, Input, Textarea, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Dialog, DialogContent, DialogHeader, DialogTitle, Separator, Alert, AlertDescription, AlertTitle } from '@chatstack/ui';
import { Heart, MessageCircle, Share2, Bookmark, MoreHorizontal, Search, Filter, TrendingUp, Clock, Award, MapPin, Users, Camera, MessageSquare, ThumbsUp, Eye, Plus, AlertTriangle } from '@chatstack/ui';
...
import { validateAndDedupeFiles } from '@/lib/file-utils';
